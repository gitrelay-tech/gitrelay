...
The quick reverse endpoint supports four providers. Set **`GITRELAY_QUICK_LLM`** to pin one, or leave it unset (`auto`) to let the app use whichever key it finds first:
